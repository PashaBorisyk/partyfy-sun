...
package object implicits {
   ...
   implicit val tokenRepRegistrationFormat: OFormat[TokenRepRegistration] = Json.format[TokenRepRegistration]
   implicit val tokenRepPrivateFormat: OFormat[TokenRepPrivate] = Json.format[TokenRepPrivate]
